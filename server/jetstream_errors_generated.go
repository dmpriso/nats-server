...
const (
	...
	JSConsumerInactiveThresholdExcess ErrorIdentifier = 10150
...
var (
	ApiErrors = map[ErrorIdentifier]*ApiError{
		...
		JSConsumerInactiveThresholdExcess:          {Code: 400, ErrCode: 10150, Description: "consumer inactive threshold exceeds system limit of {limit}"},
