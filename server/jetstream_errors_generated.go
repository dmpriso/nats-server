...
const (
	...
	JSConsumerInactiveThresholdExcessErrF ErrorIdentifier = 10150
...
var (
	ApiErrors = map[ErrorIdentifier]*ApiError{
		...
		JSConsumerInactiveThresholdExcessErrF:      {Code: 400, ErrCode: 10150, Description: "duplicate source configuration detected"},
